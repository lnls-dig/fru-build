 ...
 *
 *   Copyright (C) 2017  Henrique Silva <henrique.silva@lnls.br>
 *
...
static uint8_t calculate_chksum ( uint8_t * buffer, uint8_t range )
{
    uint8_t chksum = 0;
    uint8_t i;
    for ( i = 0; i < range; i++ ) {
